        ...
        <div><h3>Is Ilani Formu</h3><hr />
            ...
            {({ isSubmitting}) => (
                <Form onSubmit={formik.handleSubmit}>
                    <div>
                        <label htmlFor="job">Is Pozisyonu  </label>
                        <Field as="select" type="number" id="job" name="job"
                            placeholder="Ýs Pozisyonu" value={formik.values.job.id}
                    ...
                    <div>
                        ...
                        <br />
                        <div><button class="ui primary button" type="submit" >Is Ilani Ekle </button></div>
                    </Form>
                )}
            </Formik>
        </div>
